...
public class CommandWordsShop {
    ...
    public CommandWordsShop() //Takes the commanwords from the CommandWordShop Class, and puts them in the hashmap.
    {
    ...
    public CommandWordShop getCommandWordShop(String commandWordShop) // to see whether the command is a valid or invalid one..
    {
    ...
    public void showAll() // portraying the available commands.
    {
